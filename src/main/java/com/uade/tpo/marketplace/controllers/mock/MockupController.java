...
public class MockupController {
  ...
  public ResponseEntity<ResponseData<String>> initializeBooksDB(@AuthenticationPrincipal UserDetails userDetails) {
    try {
      ...
      Book book1 = new Book(null, "1984", "George Orwell", "Secker & Warburg",
          "Una distopía política sobre un régimen totalitario.", "978-0451524935",
          List.of(GenreBook.FICCION, GenreBook.DYSTOPIA, GenreBook.POLITICAL), 18.99, 12,
          "https://covers.openlibrary.org/b/id/8225631-L.jpg", true);
      Book book2 = new Book(null, "Cien Años de soledad", "Gabriel García Marquez", "Editorial Sudamericana",
          "La saga de la familia Buendía en el mítico pueblo de Macondo.", "978-0307474728",
          List.of(GenreBook.MAGICALREALISM, GenreBook.FICCION), 21.99, 8,
          "https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1327881361i/320.jpg", true);
      Book book3 = new Book(null, "Don Quijote de la Mancha", "Miguel de Cervantes", "Real Academia Española",
          "Las aventuras del ingenioso hidalgo Don Quijote.", "978-8424938437",
          List.of(GenreBook.CLASSIC, GenreBook.ADVENTURE, GenreBook.SATIRE), 23.99, 10,
          "https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1546112331i/3836.jpg", true);
      Book book4 = new Book(null, "El Señor de los Anillos", "J.R.R. Tolkien", "Minotauro",
          "La épica aventura de Frodo para destruir el Anillo Único.", "978-0544003415",
          List.of(GenreBook.FANTASY, GenreBook.ADVENTURE), 25.99, 15,
          "https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1566425108i/33.jpg", true);
      Book book5 = new Book(null, "Rayuela", "Julio Cortázar", "Alfaguara",
  ...
  public ResponseEntity<ResponseData<String>> initializeAdminsDB(@AuthenticationPrincipal UserDetails userDetails) {
    try {
      ...
      return ResponseEntity.status(HttpStatus.OK)
          .body(ResponseData.success("Base de admins inicializada correctamente!"));
